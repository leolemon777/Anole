...
- CLI: `anole engines verify <manifest> --keyring <keyring.json>` prints trust, review, and derived certification, and fails closed on non-trusted states when a keyring is supplied. Doctor prints the same derived certification.
